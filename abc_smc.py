...
version="ACDC_abcsmc_1" #name of folder
pl= None #prior_label
ncpuss = 40
...
def main(argv):
    ...
    Sequential_ABC(x_data, ncpus=ncpuss, initial_dist = initdist, final_dist =finaldist, prior_label = pl, Npars=1000, adaptative_kernel = False) 
